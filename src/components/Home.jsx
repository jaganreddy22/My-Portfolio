    ...
    >
      <div className="home-content">
        ...
        <div className="home-sci">
          <a
            href="https://www.instagram.com/_mr__reddy_._/"
            target="_blank"
            rel="noreferrer"
            style={{ '--i': 8 }}
          >
          ...
          <a
            href="https://www.linkedin.com/in/jagan-mohan-reddy-basireddy"
            target="_blank"
            rel="noreferrer"
            style={{ '--i': 10 }}
          >
        ...
        <a href="/assets/Resume.pdf" className="btn-box" download>
          Download CV
        </a>
      </div>
    </section>
